...
add_action('widgets_init','silver_price_chart_init');

function silver_price_chart_init(){
         register_widget('silver_price_chart_widget');
}


class silver_price_chart_widget extends WP_widget{

      function silver_price_chart_widget(){
	       $options = array(
		        "classname" => "silver-price-chart",
				"description" => "Live Silver price chart widget"
				);
	       $this->WP_widget("widget-silver-price", "Silver Price Chart");
	  }
	  function widget($args,$instance){
	        extract($args);
			echo $before_widget;
...
add_action('widgets_init','silver_price_live_init');

function silver_price_live_init(){
    register_widget('silver_price_live_widget');
}


class silver_price_live_widget extends WP_widget{

    function silver_price_live_widget(){
        $options = array(
            "classname" => "silver-price-live",
            "description" => "Live Silver price widget"
        );
        $this->WP_widget("widget-silver-price-live", "Live Silver Price");
    }
    function widget($args,$instance){
        extract($args);
        echo $before_widget;
        echo $before_title.$instance["title"].$after_title;
        ?>
        <iframe src="<?php echo __('https://www.goldbroker.com', 'gold-price-widget'); ?>/widget/live-price/XAG?currency=<?php echo $instance["currency"]; ?>" width="100%" height="130" style="border: 0; overflow:hidden;"></iframe>
        <?php
        echo $after_widget;
    }
    function update($new,$old){
    ...
    function form($instance){
        ...
        $instance = wp_parse_args( (array) $instance, array( 'title' => __( "Silver Price", "gold-price-widget"), 'currency' => 'USD' ) );
        $title = $instance['title'];
        $currency = $instance['currency'];
...
add_action('widgets_init','gold_price_live_init');

function gold_price_live_init(){
    register_widget('gold_price_live_widget');
}


class gold_price_live_widget extends WP_widget{

    function gold_price_live_widget(){
        $options = array(
            "classname" => "gold-price-live",
            "description" => "Live Gold price widget"
        );
        $this->WP_widget("widget-gold-price-live", "Live Gold Price");
    }
    function widget($args,$instance){
        extract($args);
        echo $before_widget;
        echo $before_title.$instance["title"].$after_title;
        ?>
        <iframe src="<?php echo __('https://www.goldbroker.com', 'gold-price-widget'); ?>/widget/live-price/XAU?currency=<?php echo $instance["currency"]; ?>" width="100%" height="130" style="border: 0; overflow:hidden;"></iframe>
        <?php
        echo $after_widget;
    }
    function update($new,$old){
    ...
    function form($instance){
        ...
        $instance = wp_parse_args( (array) $instance, array( 'title' => __( "Gold Price", "gold-price-widget"), 'currency' => 'USD' ) );
        $title = $instance['title'];
        $currency = $instance['currency'];
